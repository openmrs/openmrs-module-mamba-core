...
BEGIN
    ...
    DECLARE current_auto_table_column_name VARCHAR(60) COLLATE utf8mb4_unicode_ci;
    DECLARE previous_auto_table_column_name VARCHAR(60) COLLATE utf8mb4_unicode_ci DEFAULT '';
    DECLARE counter INT DEFAULT 0;

    DECLARE cur CURSOR FOR
        SELECT concept_id, auto_table_column_name COLLATE utf8mb4_unicode_ci
        FROM mamba_dim_concept
        ORDER BY auto_table_column_name COLLATE utf8mb4_unicode_ci;
    ...
    (
        concept_id             INT,
        auto_table_column_name VARCHAR(60) COLLATE utf8mb4_unicode_ci
    )
        CHARSET = UTF8MB4;
    ...
    LOOP
        ...
        IF current_auto_table_column_name COLLATE utf8mb4_unicode_ci = 
           previous_auto_table_column_name COLLATE utf8mb4_unicode_ci THEN
            ...
            SET current_auto_table_column_name = CONCAT(
                    ...
                    '_',
                    counter) COLLATE utf8mb4_unicode_ci;
        ELSE
            SET counter = 0;
    ...
    SET c.auto_table_column_name = t.auto_table_column_name COLLATE utf8mb4_unicode_ci
