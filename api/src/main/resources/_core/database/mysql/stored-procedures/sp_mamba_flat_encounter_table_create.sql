...
BEGIN
    ...
    IF @column_labels IS NOT NULL THEN
        SET @create_table = CONCAT(
                ...
                '` (encounter_id INT NOT NULL, client_id INT NOT NULL, encounter_datetime DATETIME NOT NULL, location_id INT NULL, ',
                @column_labels,
                ', INDEX idx_encounter_id (encounter_id), INDEX idx_client_id (client_id), INDEX idx_encounter_datetime (encounter_datetime), INDEX idx_location_id (location_id));');
    END IF;
